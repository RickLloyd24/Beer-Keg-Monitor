...
There is a **VGATest** program that displays all 64 colors and can help you test the VGA interface.  The following is a sample of the test display showing all 64 colors.
