/* Use ESP32 WROOM Dev Module* Minimal SPIFFS, Arduino Core 1, Events Core 0 */
#include <Arduino.h>
#include <TimeLib.h>
...
#include <HX711_Single_Clk.h>     //HX711 Library I wrote my self   
#include "Constants.h"
...
float TemperatureBias[] = {0.0, 0.0, 0.0};              /* Average Delta, Bias #1, Bias #2 */
float Temperature[] = {0, -1, -1};                      /* Average Temperature, Sensor #1, Sensor #2 */
...
/* Setup Pin Modes */
  ...
  pinMode(DHTPIN1Power, OUTPUT);
  pinMode(DHTPIN2Power, OUTPUT);
